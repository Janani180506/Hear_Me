...
class Application:
    ...
    def __init__(self):
        ...
        self.panel.place(x=50, y=3, width=400, height=500)

        self.panel2 = tk.Label(self.root)  # initialize image panel
        self.panel2.place(x=500, y=50, width=300, height=300)

        self.T = tk.Label(self.root)
        self.T.place(x=60, y=5)
        self.T.config(text="Sign Language To Text Conversion", font=("Courier", 22, "bold"))

        self.panel3 = tk.Label(self.root)  # Current Symbol
        self.panel3.place(x=280, y=480)
        ...
        self.T4.place(x=10, y=560)
        self.T4.config(text="Suggestions :", fg="red", font=("Courier", 30, "bold"))


        self.b1=tk.Button(self.root)
        self.b1.place(x=250,y=560)

        self.b2 = tk.Button(self.root)
        self.b2.place(x=450, y=560)

        self.b3 = tk.Button(self.root)
        self.b3.place(x=650, y=560)

        self.b4 = tk.Button(self.root)
        self.b4.place(x=850, y=560)

       # Clear Button
        self.clear = tk.Button(self.root)
        self.clear.place(x=950, y=520, width=120, height=40)
        self.clear.config(text="Clear", font=("Courier", 15, "bold"), command=self.clear_fun)

        # Speak Button
        self.speak = tk.Button(self.root)
        self.speak.place(x=1100, y=520, width=120, height=40)
        self.speak.config(text="Speak", font=("Courier", 15, "bold"), command=self.speak_fun)
    ...
    def speak_fun(self):
        self.speak_engine.stop()   #  important
